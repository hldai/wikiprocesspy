...
entityonly_title_wid_file = os.path.join(res_dir, 'wiki/el/enwiki-20190101-title-wid-entityonly.txt')
...
# core_title_wid_file = os.path.join(res_dir, 'wiki/el/enwiki-20151002-title-wid-core.txt')
...
# wikiprocess.gen_core_title_wid_file(entityonly_title_wid_file, entity_linked_cnt_file, 10, core_title_wid_file)
